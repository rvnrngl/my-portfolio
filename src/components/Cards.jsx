  ...
  return (
    <>
      ...
      >
        ...
        />
        <div className="absolute -bottom-full left-8 group-hover:bottom-[30%] transition-all duration-300 z-50">
        ...
        <div className="absolute -bottom-full left-8 group-hover:bottom-[7%] transition-all duration-700 z-50">
